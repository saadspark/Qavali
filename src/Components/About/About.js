    ...
    <section className="skills spad">
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-6 p-0">
                    <div className="skills__video set-bg" style={{ backgroundImage: `url(${skillVideo})`}}>
                        <a href="https://www.youtube.com/watch?v=S19UcWdOA-I?autoplay=1" className="play-btn video-popup"><i className="fa fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="row">
                <div className="col-lg-4 col-md-6 col-sm-6">
                    <div className="about__services__item">
                        <div className="about__services__item__pic set-bg" style={{ backgroundImage: `url(${as1})`}}>
                            <div className="icon">
                                <img src={asIcon1} alt=""/>
                            </div>
                        </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                    <div className="about__services__item">
                        <div className="about__services__item__pic set-bg" style={{ backgroundImage: `url(${as2})`}}>
                            <div className="icon">
                                <img src={asIcon2} alt=""/>
                            </div>
                        </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                    <div className="about__services__item">
                        <div className="about__services__item__pic set-bg" style={{ backgroundImage: `url(${as3})`}}>
                            <div className="icon">
                                <img src={asIcon3} alt=""/>
                            </div>
                        </div>
